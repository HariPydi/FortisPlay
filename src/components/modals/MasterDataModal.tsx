...
const masterItemsSet1 = [
    'Venues', 'Pools', 'Distributions', 'Users'
];
const masterItemsSet2 = [
    'Locations', 'Enclosures', 'Terminals', 'Users KYC'
];
...
const modal = StyleSheet.create({
    ...
    title: { fontFamily: FontFamily.primaryFont, fontSize: 20, fontWeight: '700', color: Colors.textDark, lineHeight: 28, letterSpacing: 0, textAlign: 'center' },
    subtitle: {
    ...
    listContainer: { flexDirection: 'row', justifyContent: 'space-between', gap: 16 },
    listGrid: { gap: 6 },
    ...
    cancelBtn: {
        ...
        paddingLeft: 12, paddingRight: 16, gap: 4,
    },
    buttonIcon: { width: 20, height: 20 },
    cancelText: { fontSize: 15, fontWeight: '600', color: '#2979FF' },
    goBtn: {
        flex: 2, flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
        backgroundColor: '#2563FF', borderRadius: 8, paddingVertical: 8,
        borderWidth: 1.5, borderColor: '#2563FF',
        paddingLeft: 12, paddingRight: 16, gap: 4,
    },
